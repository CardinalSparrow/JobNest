				...
				>
					...
					<div className="flex flex-col sm:flex-row sm:gap-20 lg:gap-40 bg-background3 p-4">
						...
						<div className="grid w-full sm:w-1/2">
							<label className="grid relative" htmlFor="password">
								...
								{passwordVisible.password ? (
									<MdOutlineVisibilityOff
										onClick={() =>
											togglePasswordVisibilty("password", setPasswordVisible)
										}
										className="absolute right-2 top-9 size-5"
									/>
								) : (
									<MdOutlineVisibility
										onClick={() =>
							...
							<label className="grid relative" htmlFor="confirmPassword">
								Confirm Password
								<input
									className="focus:outline-none p-2 rounded-sm mb-4"
							...
							<label className="grid" htmlFor="location">
								Location
								<select
									className="focus:outline-none p-2 rounded-sm mb-4"
									name="location"
					...
					<a href="#work">
						<p className="flex justify-self-end bg-secondary text-white p-2 rounded-md">
							Next
							<TiArrowDownThick className="self-center size-6" />
						</p>
					</a>
					...
					<label htmlFor="portfolioLink" className="grid mb-4">
						...
						<input
							type="text"
							className="border-2 rounded-sm p-2 mt-2"
							name="portfolioLink"
							id="portfolioLink"
						...
						{formErrors.portfolioLink && (
							<p className="text-red-600">{formErrors.portfolioLink}</p>
						)}
					</label>
					<div className="flex sm:w-3/5 md:w-2/5 gap-4 bg-primary p-4 mb-4">
						...
						<p className="text-xs self-center text-white">
							<Link>
								By ticking this, i agree to receiving emails about jobnest alert
								and updates. In addition, you also agree to jobnest's User
								agreement and Privacy Policy
							</Link>
						</p>
					</div>
					<button
						className="bg-secondary p-2 mb-2 text-white justify-self-end flex rounded-md"
						type="submit"
						disabled={loading}
					>
						{loading ? (
