...
export default function RecruiterProfile() {
  ...
  const btnClass = (component) =>
    ` mr-7 p-2 transition text-primary transition-all duration-500 hover:border-b-2 hover:border-primary hover:font-[600] ${
  ...
  return (
    <div className=" w-[80vw] mx-auto">
      <ProfileDetails />
      <div className="border-b border-l-gray-500 my-10 pb-2">
        <button
