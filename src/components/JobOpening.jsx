  ...
  return (
    <div className="w-[300px] h-[150px] mb-6 flex flex-col justify-between p-[5px] bg-white">
      <div className="flex justify-between">
        <div className={`flex justify-center items-center bg-background2-100 w-[68px] h-[45px]`}>
      ...
      <div className={`flex justify-end`}>
        <button className="bg-secondary text-white p-1 text-sm font-medium rounded-md">Apply Now!</button>
      </div>
    </div>
  );
}
