...
export default function AboutCompany() {
  return (
    <div className=" bg-background2-100 p-10">
      <div>
        <h2 className="text-primary text-xl font-[600]">About Us</h2>
        <p>
      ...
      <div className="mt-7">
        <h2 className="text-primary text-xl font-[600]">Why Join Us?</h2>
        <p>
          {" "}
        ...
        <p>
          {" "}
          <FontAwesomeIcon icon={faCheck} /> Explore career opportunities with us and become part of our mission to
